/**
 * Lightweight stroke icon set (lucide-style). Icons inherit color via
 * `currentColor`, so set `color` on the parent or pass `style`.
 */
function Svg({ children, size = 18, stroke = 2, fill = 'none', style }) {
  return (
    <svg
      width={size}
      height={size}
